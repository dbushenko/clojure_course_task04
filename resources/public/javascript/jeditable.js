    ...
    $.fn.editable = function (target, options) {
        ...
        return this.each(function () {
            ...
            $(this).bind(settings.event, function (e) {
                ...
                //edit
                settings.width = settings.width + settings.padding.width;
                settings.height = settings.height + settings.padding.height
                //end edit
                ...
                if (settings.style) {
                    if ('inherit' == settings.style) { form.attr('style', $(self).attr('style')); form.css('display', $(self).css('display')); } else { form.attr('style', settings.style); }
                }
                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) {
                        if (false !== submit.apply(form, [settings, self])) {
                            if ($.isFunction(settings.target)) {
                                ...
                                $(self).html(str); self.editing = false;
            ...
            defaults: {
                ...
                element: function (settings, original) {
                    ...
                    if (settings.inputStyle != '') {
                        input.attr("style", settings.inputStyle);
                    }
        ...
        name: 'value', id: 'id', type: 'text', width: 'auto', height: 'auto', event: 'click.editable', onblur: 'cancel', loadtype: 'GET', loadtext: 'Loading...', placeholder: 'Click to edit', loaddata: {}, submitdata: {}, ajaxoptions: {}, padding: { height: 0, width: 0 }, inputStyle: ""
    };
})(jQuery);